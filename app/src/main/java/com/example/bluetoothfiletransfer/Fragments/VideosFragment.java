...
import com.example.bluetoothfiletransfer.ViewModel.VideosViewModel;
...
public class VideosFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        videosViewModel.getVideosLiveData().observe(getViewLifecycleOwner(), new Observer<ArrayList<AllItemModelClass>>() {
            @Override
            public void onChanged(ArrayList<AllItemModelClass> videosList) {
                updateView(videosList);
            }
        });
    ...
    public class AsyncTaskClass extends AsyncTask<String, String, ArrayList<AllItemModelClass>> {
        ...
        public void onPostExecute(ArrayList<AllItemModelClass> arrayList) {
            ...
            if (arrayList != null) {
                videosViewModel.setVideoData(arrayList);
