...
public class PicsAdapter extends RecyclerView.Adapter<PicsAdapter.ViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        ((RequestBuilder) ((RequestBuilder) ((RequestBuilder) Glide.with(this.mContext).load(allItemModelClass.getImgPath()).thumbnail(0.5f).diskCacheStrategy(DiskCacheStrategy.ALL)).skipMemoryCache(true)).placeholder((int) R.drawable.notfound)).into(viewHolder.iv_image);
